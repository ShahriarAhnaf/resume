...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItem {\textbf{Unity/Cmock Test framework}: Lead developer for optimization for unit testing, achieving up to \textit{30\% faster} runtime while using \textit{50\%} less manually written test cases.} 
       \resumeItem {\textbf{Automation:} Improved \textit{Jenkins CI/CD} pipelines to support unit testing automatino using \textit{Python} for Linux server.}
        ...
        \resumeItem {{Automotive Design}Implemented \textit{AUTOSAR} standard Embedded hardware with \textit{ISO26262 safety design} using \textit{Davinci Configurator}.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem {\textbf{Testing:} Programmed {smoketesting firmware} in C for \textbf{STM32} processors in Linux virtual machine using Vagrant \textbf{Virtual Box}. }
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Tools}{: Quartus, Git, Linux, Qemu,  OpenSSL, GNU Tools, Green Hills, Docker, WireShark, Jenkins, UVM, Matlab} \\
